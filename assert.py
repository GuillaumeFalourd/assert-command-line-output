...
def main():
    ...
    if not (
        (sys.argv[2][0] == "_") and (sys.argv[3][0] == "_") and (sys.argv[4][0] == "_")
    ):
        sys.exit(
    ...
    if input_contains:
        ...
        if isinstance(input_specific_line, int):
    ...
    print(f"Expected: {input_expected_result}", f"Actual: {test_result}", sep="\n")
